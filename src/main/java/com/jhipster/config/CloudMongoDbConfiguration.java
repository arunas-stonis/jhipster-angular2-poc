...
import com.jhipster.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("com.jhipster.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("com.jhipster.config.dbmigrations");
